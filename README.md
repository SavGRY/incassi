...
- Generate a new FastAPI secret key [Here is the snippet](https://fastapi.tiangolo.com/tutorial/security/oauth2-jwt/#hash-and-verify-the-passwords)
    - `openssl rand -hex 32`
...
In the core folder of the FastAPI project
find the `alembic.ini.example` and remove the `.example`.
...
For the frontend is advisable to install the `node_modules`
locally even tho there's the docker container.
...
- `docker compose pull <service-you-want-to-pull>`
- `docker compose up -d <services>`

> [!NOTE]
>
> This project has renovate implementation
