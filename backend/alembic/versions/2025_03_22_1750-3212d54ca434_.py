...
#         sa.Column(
#             "type_of_payment",
#             postgresql.ENUM("check", "cash", name="typeofincasso"),
#             autoincrement=False,
#             nullable=False,
#         ),
#         sa.Column(
...
#             ["client_code"],
#             ["client.code"],
#             name="incasso_client_code_fkey",
#             ondelete="CASCADE",
#         ),
#         sa.PrimaryKeyConstraint("id", name="incasso_pkey"),
#     )
#     op.create_table(
#         "document",
#         sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
...
#         sa.Column(
#             "province", sa.VARCHAR(length=2), autoincrement=False, nullable=False
#         ),
#         sa.PrimaryKeyConstraint("code", name="client_pkey"),
#     )
#     op.create_table(
#         "user",
#         sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
